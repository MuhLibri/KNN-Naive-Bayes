...
df_train = utils.read_csv("data_train.csv")
df_validation = utils.read_csv("data_validation.csv")
...
print("Accuracy: ", implement.knn_sklearn(x_train, x_validation, train_target, validation_target))
